...
<body>
          ...
          <div class="col-lg-6" data-aos="fade-right">
            ...
            <?php
                ...
                while($data=mysqli_fetch_assoc($run)){
                    ...
                    <button type="submit" style="background-color:#138963; color: white; border-radius: 8px;" value="<?php  echo $data['ID'];  ?>" name="fromID">Select</button>
                    </form>
                    </div>
                <?php
                    $i++;
  ...
  <footer id="footer">
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><a href="https://github.com/ibshaikh"><span>Ibram Shaikh</span></a></strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- End Footer -->
